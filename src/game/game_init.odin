...
game_mode_init :: proc() {
    ...
    append(&_mem.game.asset_units, engine.asset_add("media/units/ramza.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/delita.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/alma.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/agrias.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/mustadio.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/boco.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/rapha.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/wiegraf.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/belias.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/gaffgarion.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/lavian.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/alicia.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/ladd.txt", .External))
    append(&_mem.game.asset_units, engine.asset_add("media/units/cidolfus.txt", .External))

    for unit_asset in _mem.game.asset_units {
        engine.asset_load(unit_asset, engine.Asset_Load_Options_External { load_proc = auto_cast(create_unit_info) })
    }
