...
game_mode_init :: proc() {
    ...
    append(&_mem.game.asset_units, engine.asset_add("media/units/01.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/02.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/03.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/04.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/05.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/06.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/07.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/08.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/09.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/10.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/11.json", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/12.json", .External, external_id = external_id_unit))
