...
game_mode_init :: proc() {
    ...
    external_id_unit := engine.asset_register_external({ load_proc = create_unit_info, print_proc = print_unit_info })
    // TODO: create engine.asset_add_all_from_folder("media/units/") or asset_add_multiple_from_file("medias/all_units.txt")
    append(&_mem.game.asset_units, engine.asset_add("media/units/ramza.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/delita.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/alma.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/agrias.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/mustadio.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/boco.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/rapha.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/wiegraf.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/belias.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/gaffgarion.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/lavian.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/alicia.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/ladd.txt", .External, external_id = external_id_unit))
    append(&_mem.game.asset_units, engine.asset_add("media/units/cidolfus.txt", .External, external_id = external_id_unit))
