...
game_mode_worldmap :: proc() {
    if game_mode_entering() {
        ...
        _mem.game.world_data.level = make_level(asset_info.ldtk, 0, _mem.game.level_assets, &_mem.game.world_data.entities, 1, _mem.game.asset_shader_sprite, _mem.game.game_mode.arena.allocator)
