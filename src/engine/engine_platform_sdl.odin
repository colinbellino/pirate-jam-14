...
platform_resize_window :: proc(native_resolution: Vector2i32) {
    ...
    _r.camera.projection_matrix = matrix_ortho3d_f32(0, f32(_r.rendering_size.x) / f32(_r.rendering_scale), f32(_r.rendering_size.y) / f32(_r.rendering_scale), 0, 0, 1)
    _r.camera.view_matrix = matrix4_translate_f32({ 0, 0, 0 })
}
