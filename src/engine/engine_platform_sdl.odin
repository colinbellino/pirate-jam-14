...
platform_resize_window :: proc() {
    ...
    renderer_set_viewport({ f32(_engine.platform.window_size.x) * _engine.renderer.pixel_density, f32(_engine.platform.window_size.y) * _engine.renderer.pixel_density })
