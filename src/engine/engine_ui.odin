...
when IMGUI_ENABLE {
    ...
    ui_progress_bar :: proc(fraction: f32, size_arg := Vec2(Vec2 {-min(f32),0}), overlay := "") { }
    ui_get_content_region_avail :: proc(pOut: ^Vec2) { }
    ui_text :: proc(fmt_: string, args: ..any) { }
    ui_button :: proc(label: string, size := Vec2(Vec2 {0,0})) -> (result: bool) { return }

    ui_begin_table ::proc(str_id: string, column: i32, flags := Table_Flags(0), outer_size := Vec2(Vec2 {0.0,0.0}), inner_width := f32(0.0)) -> (result: bool) { return }
    ...
    ui_set_window_pos_str :: proc(name: string, pos: Vec2, cond := Cond(0)) { }
    ui_plot_lines :: proc {
        ui_plot_lines_float_ptr,
        ui_plot_lines_fn_float_ptr,
    }
    ui_plot_lines_float_ptr :: proc(label: string, values: ^f32, values_count: i32, values_offset := i32(0), overlay_text := "", scale_min := f32(max(f32)), scale_max := f32(max(f32)), graph_size := Vec2(Vec2 {0,0}), stride := i32(size_of(f32))) { }
    ui_plot_lines_fn_float_ptr :: proc(label: string, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: string, scale_min: f32, scale_max: f32, graph_size: Vec2) { }
    ...
    ui_push_id_str :: proc(str_id: string) { }
    ui_push_id_str_str :: proc(str_id_begin: string, str_id_end: string) { }
    ...
    ui_input_double :: proc(label: string, v: ^f64, step := f64(0.0), step_fast := f64(0.0), format := "%.6f", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_float :: proc(label: string, v: ^f32, step := f32(0.0), step_fast := f32(0.0), format := "%.3f", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_float2 :: proc(label: string, v: [2]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_float3 :: proc(label: string, v: [3]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_float4 :: proc(label: string, v: [4]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_int :: proc(label: string, v: ^i32, step := i32(1), step_fast := i32(100), flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_int2 :: proc(label: string, v: [2]i32, flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_int3 :: proc(label: string, v: [3]i32, flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_int4 :: proc(label: string, v: [4]i32, flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_scalar :: proc(label: string, data_type: Data_Type, p_data: rawptr, p_step : rawptr = nil, p_step_fast : rawptr = nil, format := "", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_scalar_n :: proc(label: string, data_type: Data_Type, p_data: rawptr, components: i32, p_step : rawptr = nil, p_step_fast : rawptr = nil, format := "", flags := Input_Text_Flags(0)) -> bool { return false }
    ui_input_text :: proc(label: string, buf: []u8, flags := Input_Text_Flags(0), callback : Input_Text_Callback = nil, user_data : rawptr = nil) -> bool { return false }
    ui_input_text_multiline :: proc(label: string, buf: string, buf_size: uint, size := Vec2(Vec2 {0,0}), flags := Input_Text_Flags(0), callback : Input_Text_Callback = nil, user_data : rawptr = nil) -> bool { return false }
    ui_input_text_with_hint :: proc(label: string, hint: string, buf: string, buf_size: uint, flags := Input_Text_Flags(0), callback : Input_Text_Callback = nil, user_data : rawptr = nil) -> bool { return false }

    ui_begin :: proc(name: string, p_open : ^bool = nil, flags := Window_Flags(0)) -> bool { return false }
    ui_begin_child :: proc {
        ui_begin_child_str,
        ui_begin_child_id,
    }
    ui_begin_child_str :: proc(str_id: string, size := Vec2(Vec2 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool { return false }
    ui_begin_child_id :: proc(id: ImID, size := Vec2(Vec2 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool { return false }
    ...
    ui_tree_node_ex_str :: proc(label: string, flags := Tree_Node_Flags(0)) -> bool { return false }
    ui_tree_node_ex_str_str :: proc(str_id: string, flags: Tree_Node_Flags, fmt_: string, args: ..any) -> bool { return false }
    ui_tree_node_ex_ptr :: proc(ptr_id: rawptr, flags: Tree_Node_Flags, fmt_: string, args: ..any) -> bool { return false }
    ...
    ui_tree_push_str :: proc(str_id: string) { }
    ui_tree_push_ptr :: proc(ptr_id : rawptr = nil) { }

    ui_begin_main_menu_bar :: proc() -> bool { return false }
    ui_begin_menu :: proc(label: string, enabled := bool(true)) -> bool { return false }
