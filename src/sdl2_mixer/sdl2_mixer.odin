...
DEFAULT_FORMAT :: sdl2.AUDIO_S16SYS
DEFAULT_CHANNELS :: 2
...
/* We'll use sdl2 for reporting errors */
SetError   :: sdl2.SetError
GetError   :: sdl2.GetError
ClearError :: sdl2.ClearError

LoadWAV :: #force_inline proc "c" (file: cstring) -> ^Chunk {
    return LoadWAV_RW(sdl2.RWFromFile(file, "rb"), true)
}
...
foreign lib {
    Linked_Version :: proc() -> ^sdl2.version ---
    ...
    LoadWAV_RW           :: proc(src: ^sdl2.RWops, freesrc: bool) -> ^Chunk ---
    LoadMUS              :: proc(file: cstring) -> ^Music ---
    LoadMUS_RW           :: proc(src: ^sdl2.RWops, freesrc: bool) -> ^Music ---
    LoadMUSType_RW       :: proc(src: ^sdl2.RWops, type: MusicType, freesrc: bool) -> ^Music ---
