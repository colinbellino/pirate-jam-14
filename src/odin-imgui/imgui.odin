...
WindowFlags_NoNav        : WindowFlag : .NoNavInputs | .NoNavFocus
WindowFlags_NoDecoration : WindowFlag : .NoTitleBar | .NoResize | .NoScrollbar | .NoCollapse
WindowFlags_NoInputs     : WindowFlag : .NoMouseInputs | .NoNavInputs | .NoNavFocus
...
foreign lib {
	...
	@(link_name="ImGui_Begin") Begin :: proc(name: cstring, p_open: ^bool, flags: WindowFlag) -> bool ---
	...
	//    BeginPopup/EndPopup, etc. where the EndXXX call should only be called if the corresponding BeginXXX function
	//    returned true. Begin and BeginChild are the only odd ones out. Will be fixed in a future update.]
	@(link_name="ImGui_BeginChild")   BeginChild   :: proc(str_id: cstring, size: Vec2, border: bool, flags: WindowFlag) -> bool ---
	@(link_name="ImGui_BeginChildID") BeginChildID :: proc(id: ID, size: Vec2, border: bool, flags: WindowFlag) -> bool          ---
    ...
    // @(link_name="ImGui_PushItemFlag")     PushItemFlag     :: proc(option: ItemFlag, enabled: bool) ---
	...
	@(link_name="ImGui_BeginPopup")      BeginPopup      :: proc(str_id: cstring, flags: WindowFlag) -> bool              --- // return true if the popup is open, and you can start outputting to it.
	@(link_name="ImGui_BeginPopupModal") BeginPopupModal :: proc(name: cstring, p_open: ^bool, flags: WindowFlag) -> bool --- // return true if the modal is open, and you can start outputting to it.
	...
	@(link_name="ImGui_BeginChildFrame")       BeginChildFrame       :: proc(id: ID, size: Vec2, flags: WindowFlag) -> bool --- // helper to create a child window / scrolling region that looks like a normal widget frame
